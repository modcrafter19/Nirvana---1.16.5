...
//COPPER
	event.removeOres((ores) => {
		ores.blocks = ['immersiveengineering:ore_copper', 'mekanism:copper_ore', 'create:copper_ore', 'thermal:copper_ore', 'tmechworks:copper_ore', 'mysticalworld:copper_ore', 'silents_mechanisms:copper_ore', 'tconstruct:copper_ore', 'occultism:copper_ore'];
	});
...
//SILVER
	event.removeOres((ores) => {
		ores.blocks = ['immersiveengineering:ore_silver', 'thermal:silver_ore', 'mysticalworld:silver_ore', 'silents_mechanisms:silver_ore', 'occultism:silver_ore'];
	});
